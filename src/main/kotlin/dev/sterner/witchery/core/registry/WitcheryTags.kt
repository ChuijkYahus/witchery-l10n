...
object WitcheryTags {
    ...
    val STATUS_EFFECT_BLACKLIST_LICH = TagKey.create(Registries.MOB_EFFECT, Witchery.id("blacklist_lich"))
    val STATUS_EFFECT_WHITELIST_SOUL_FORM = TagKey.create(Registries.MOB_EFFECT, Witchery.id("whitelist_soul_form"))
    val STATUS_EFFECT_BLACKLIST_VAMPIRE = TagKey.create(Registries.MOB_EFFECT, Witchery.id("blacklist_vampire"))
    val STATUS_EFFECT_BLACKLIST_WEREWOLF = TagKey.create(Registries.MOB_EFFECT, Witchery.id("blacklist_werewolf"))
}