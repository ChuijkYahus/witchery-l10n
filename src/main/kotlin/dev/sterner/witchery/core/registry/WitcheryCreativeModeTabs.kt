        ...
        "main", Supplier {
            CreativeModeTab.builder()
                ...
                .displayItems { _, output ->
                    ...
                    output.accept(WitcheryItems.NECROMANTIC_SOULBIND.get())
                    ...
                    val hag3 = WitcheryItems.HAGS_RING.get().defaultInstance
                    hag3.set(WitcheryDataComponents.HAG_RING_TYPE.get(), WitcheryDataComponents.HagType.REACH)
                    ...
                    output.accept(WitcheryItems.NULLIFIED_LEATHER.get())
                    ...
                    output.accept { WitcheryItems.DEATH_HOOD.get() }
                    output.accept { WitcheryItems.DEATH_ROBE.get() }
                    output.accept { WitcheryItems.DEATH_BOOTS.get() }
                    ...
                    output.accept(WitcheryItems.MIRROR.get())
